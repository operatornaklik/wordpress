...
class Operatornaklik_REST_API {
    ...
    public static function p596979_operatornaklik_get_orders(WP_REST_Request $request)
    {
        ...
        if (!$phone && !$email && !$id) {
            ...
            echo wp_json_encode(['error' => 'Put email,phone or id to query parameters']);
            die();
        }
        ...
        if ($id) {
            $results = wc_get_order($id);
            $results = ['order' => self::formatOrder($results)];
        } elseif ($email) {
            foreach (
                wc_get_orders([
                'billing_phone' => esc_attr($phone),
                'orderby' => 'date',
                'order' => 'DESC',
                ]) as $result
            ) {
    ...
    public static function p596979_operatornaklik_get_products(WP_REST_Request $request)
    {
        ...
        if ($id) {
            ...
            $results['product'] = self::formatProduct($product);
        } elseif ($name) {
    ...
    private static function formatOrder($result)
    {
        ...
        $resultData = [
            ...
            'paid' => is_null($orderData['date_paid']) ? null : $orderData['date_paid']->date('Y-m-d H:i:s'),
    ...
    {
        $carrierConverted = trim(strtolower(strtr(strval($carrier), ['ä' => 'a','Ä' => 'A','á' => 'a','Á' => 'A',
            'à' => 'a', 'À' => 'A','ã' => 'a','Ã' => 'A','â' => 'a','Â' => 'A','č' => 'c','Č' => 'C','ć' => 'c',
            'Ć' => 'C','ď' => 'd','Ď' => 'D', 'ě' => 'e','Ě' => 'E','é' => 'e','É' => 'E','ë' => 'e','Ë' => 'E',
            'è' => 'e','È' => 'E','ê' => 'e','Ê' => 'E','í' => 'i', 'Í' => 'I','ï' => 'i','Ï' => 'I','ì' => 'i',
            'Ì' => 'I','î' => 'i','Î' => 'I','ľ' => 'l','Ľ' => 'L','ĺ' => 'l','Ĺ' => 'L', 'ń' => 'n','Ń' => 'N',
            'ň' => 'n','Ň' => 'N','ñ' => 'n','Ñ' => 'N','ó' => 'o','Ó' => 'O','ö' => 'o','Ö' => 'O','ô' => 'o',
            'Ô' => 'O','ò' => 'o','Ò' => 'O','õ' => 'o','Õ' => 'O','ő' => 'o','Ő' => 'O','ř' => 'r','Ř' => 'R',
            'ŕ' => 'r','Ŕ' => 'R', 'š' => 's','Š' => 'S','ś' => 's','Ś' => 'S','ť' => 't','Ť' => 'T','ú' => 'u',
            'Ú' => 'U','ů' => 'u','Ů' => 'U','ü' => 'u', 'Ü' => 'U','ù' => 'u','Ù' => 'U','ũ' => 'u','Ũ' => 'U',
            'û' => 'u','Û' => 'U','ý' => 'y','Ý' => 'Y','ž' => 'z','Ž' => 'Z', 'ź' => 'z','Ź' => 'Z'])));
